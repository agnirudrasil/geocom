...
import elements from "./nitk-roads.json";
...
export default function TabOneScreen() {
  ...
  const markers_cpp = {
    path: [
      ...
      [13.0095455, 74.7950478],
      [13.0098255, 74.7950354],
      [13.0098273, 74.7947342],
      [13.0098107, 74.7946376],
      [13.0098159, 74.7943399],
      [13.0098104, 74.7940217],
      [13.009821, 74.7939021],
      [13.0099513, 74.7938995],
      [13.0100715, 74.7939075],
      [13.0105685, 74.7938893],
      [13.0106555, 74.7938779],
      [13.0106564, 74.7939025],
      [13.0107384, 74.7939027],
      [13.0108325, 74.7939],
      [13.0109475, 74.793892],
      [13.0109782, 74.7938864],
      [13.0109861, 74.7938217],
      [13.0109809, 74.7934864],
  ...
  return (
    <View style={styles.container}>
      <MapView initialRegion={region} style={styles.map}>
        <Geojson strokeWidth={3} strokeColor="red" geojson={elements} />
        <Geojson
          strokeWidth={3}
          strokeColor="green"
          geojson={{
